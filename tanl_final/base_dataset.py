...
class BaseDataset(Dataset, ABC):
    ...
    def compute_features(self, max_input_length: int, max_output_length: int,
        ...
        print(add_class_choice)
        local_static_class_choice = ["person", "location", "miscellaneous", "organization"]
        ...
        if int(os.environ['DEBUG']) == 1:
            with open("./log/input.log","a+") as i1:
                for sentence in input_sentences:
                    i1.write(str(sentence) + "\n")
                
        if int(os.environ['DEBUG']) == 1:
            with open("./log/output.log","a+") as o1:
