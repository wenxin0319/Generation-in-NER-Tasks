...
class JointEROutputFormat(BaseOutputFormat):
    ...
    def format_output(self, example: InputExample) -> str:
        ...
        if int(os.environ['DEBUG']) == 1:
            with open("./log/entities.log","a+") as entity_file:
                entity_file.write("entities: " + str(example.entities) + "\n")
    ...
    def run_inference(self, example: InputExample, output_sentence: str,
        ...
        # entity_types = {"organization", "facility", "geographical entity", "location", "weapon", "vehicle", "person"}
        entity_types = {"organization", "location", "person", "miscellaneous"}
	# entity_types = set(entity_type for entity_type in entity_types1.values())
        ...
        if int(os.environ['DEBUG']) == 1:
            with open("./log/raw_entities.log","a+") as raw_entity_file:
                raw_entity_file.write("raw_entities: " + str(raw_predicted_entities) + "\n")
