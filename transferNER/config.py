...
class Config(object):
    def __init__(self, **kwargs):
        ...
        # model
        self.use_bert = kwargs.pop('use_bert', True)
        self.use_char_emb = kwargs.pop('use_char_emb', False)
        ...
        self.entity_hidden_num = kwargs.pop('entity_hidden_num', 200)
        ...
        self.word2vec_path = kwargs.pop('word2vec_path', None)
        # others
        self.gpu_device = kwargs.pop('gpu_device', 0)
        self.seed = kwargs.pop('seed', 0)
        self.use_type = kwargs.pop('use_type', ['PER', 'ORG', 'LOC', 'MISC'])
        self.test_use_type = kwargs.pop('test_use_type', ['PER', 'ORG', 'LOC', 'MISC'])
